...
describe('/First Test Collection', () => {
    ...
    it ('test default API welcome route', (done) => {
        ...
        .end((err, res) => {
            ...
            expect(actualVal).to.be.equal('Welcome to the Awesome Adoption REST API');
...
describe('User workflow tests', () => {
                    ...
                    .end((err, res) => {
                        ...
                        chai.request(server)
                            ...
                            .end((err, res) => {
                                ...
                                expect(savedCat.suitableForKids).to.be.equal(cat.suitableForKids);
                                expect(savedCat.suitableInApartment).to.be.equal(cat.suitableInApartment);
    ...
    it('should register + login a user, create cat post and delete it from DB', (done) => {
                            ...
                            .end((err, res) => {
                                ...
                                chai.request(server)
                                    ...
                                    .end((err, res) => {
                                        ...
                                        expect(res.status).to.be.equal(200);                                        
                                        const actualVal = res.body.message;
                                        expect(actualVal).to.be.equal('Cat post was successfully deleted.');        
                                        done();
                                    });
